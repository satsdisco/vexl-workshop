...
export default function GetStartedSection() {
  ...
  useEffect(() => {
    // Generate QR code for vexl.it/download
    QRCode.toDataURL('https://vexl.it/download', {
      width: 300,
      margin: 2,
      color: {
        dark: '#000000',
    ...
    <div className="max-w-6xl mx-auto h-full flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        {activeTab === 'start' ? (
          ...
          >
            <div className="vexl-card max-w-md w-full">
              <div className="flex items-center justify-center gap-3 mb-6">
                ...
                <span className="text-vexl-gray-400 text-2xl">•</span>
                <svg className="w-8 h-8" viewBox="0 0 24 24" fill="currentColor">
              ...
              {showQR && downloadQR && (
                ...
                >
                  <img src={downloadQR} alt="Download Vexl" className="w-full" />
                  <p className="text-black text-center text-sm mt-2">vexl.it/download</p>
                </motion.div>
              )}
            </div>
          </motion.div>
